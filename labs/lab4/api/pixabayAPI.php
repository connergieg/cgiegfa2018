...
function getImageURLs($keyword, $orientation="horizontal") {
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "https://pixabay.com/api/?key=10226814-b44a8e2785643d2b20c3940c5&q=$keyword&image_type=photo&orientation=$orientation&safesearch=true&per_page=100",
